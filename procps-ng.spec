...
Source0  : https://gitlab.com/procps-ng/procps/-/archive/v3.3.16/procps-v3.3.16.tar.gz
...
%prep
%setup -q -n procps-v3.3.16
cd %{_builddir}/procps-v3.3.16
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1579646976
...
%autogen --disable-static --exec-prefix=/ --enable-watch8bit --with-systemd
make  %{?_smp_mflags}
...
cp %{_builddir}/procps-v3.3.16/COPYING %{buildroot}/usr/share/package-licenses/procps-ng/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/procps-v3.3.16/COPYING.LIB %{buildroot}/usr/share/package-licenses/procps-ng/3cc956929ff9e4c1c89a2c826cdc7fec5e0b21ab
cp %{_builddir}/procps-v3.3.16/proc/COPYING %{buildroot}/usr/share/package-licenses/procps-ng/3cc956929ff9e4c1c89a2c826cdc7fec5e0b21ab
cp %{_builddir}/procps-v3.3.16/ps/COPYING %{buildroot}/usr/share/package-licenses/procps-ng/3cc956929ff9e4c1c89a2c826cdc7fec5e0b21ab
%make_install
%find_lang procps-ng
