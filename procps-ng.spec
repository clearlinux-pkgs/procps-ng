...
Source0  : https://gitlab.com/procps-ng/procps/-/archive/v4.0.3/procps-v4.0.3.tar.gz
...
Patch1: 0001-translation-hack.patch
Patch2: 0002-Fix-ncurses-inclue-dir.patch
...
%prep
%setup -q -n procps-v4.0.3
cd %{_builddir}/procps-v4.0.3
%patch -P 1 -p1
%patch -P 2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1689788866
