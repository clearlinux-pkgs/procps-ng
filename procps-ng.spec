...
Patch1: 0001-Hack-to-avoid-msgstr-error.patch
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1689837683
...
cp %{_builddir}/procps-v%{version}/proc/COPYING %{buildroot}/usr/share/package-licenses/procps-ng/3cc956929ff9e4c1c89a2c826cdc7fec5e0b21ab || :
cp %{_builddir}/procps-v%{version}/ps/COPYING %{buildroot}/usr/share/package-licenses/procps-ng/3cc956929ff9e4c1c89a2c826cdc7fec5e0b21ab || :
%make_install
%find_lang procps-ng
